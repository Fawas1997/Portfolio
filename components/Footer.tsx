  ...
  return (
    <footer className="mx-4 md:mx-0 rounded-t-3xl md:rounded-none overflow-hidden bg-gray-50 dark:bg-[#0B1120] border-t border-l border-r md:border-x-0 border-gray-200 dark:border-gray-800/50 pt-6 pb-20 md:py-12 shadow-[0_-15px_40px_-5px_rgba(0,0,0,0.05)] md:shadow-none">
      <div className="container mx-auto px-4 md:px-6 text-center w-full">
        ...
        <div className="mt-4 flex flex-col md:flex-row items-center justify-center gap-3 md:gap-2 text-xs font-medium text-gray-400 dark:text-gray-500">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-2">
            <div className="flex items-center justify-center gap-3 md:gap-2">
              ...
              <span className="flex items-center gap-1.5 whitespace-nowrap">
                <img src="/logoicon/antigravity.webp" alt="Antigravity" className="w-4 h-4 object-contain" />
