...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-white dark:bg-transparent transition-colors duration-500">
      <div className="mt-12 pt-8 lg:mt-0 lg:pt-32 pb-16 lg:pb-24 bg-gradient-to-b from-blue-50/80 via-blue-100/50 to-blue-50/80 dark:bg-transparent">
